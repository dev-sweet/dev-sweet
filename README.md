...
🌱  Learning    →  NestJS · Redis · AWS · CI/CD pipelines
🤖  AI tools   →  Claude · Codex — part of my daily dev workflow
💬  Ask me     →  Next.js · React · Node.js · TypeScript · TanStack Query
📫  Email      →  sweetali0520@gmail.com
✅  Open to    →  Remote roles & Dhaka startups
```
